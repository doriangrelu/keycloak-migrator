...
@XmlRootElement(name = "createClientRole")
@XmlAccessorType(XmlAccessType.FIELD)
public class CreateClientRoleOperation implements Operation {
    ...
    public void execute(KeycloakAdminClient client) throws Exception {
        client.createClientRole(this);
    }

    @Override
    public String getDescription() {
        return "Create client role '" + name + "' for client '" + clientId + "' in realm '" + realm + "'";
    }
